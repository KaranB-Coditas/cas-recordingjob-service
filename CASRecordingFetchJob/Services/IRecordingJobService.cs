...
namespace CASRecordingFetchJob.Services
{
    ...
    {
        Task<IActionResult> ExecuteRecordingJobAsync(DateTime? startDate = null, DateTime? endDate = null, int companyId = 0, int leadtransitId = 0, bool isRestoreCdrRecordingEnabled = false, bool addPauseAnnouncement = false, bool isDualConsent = false, bool generateSignedUrl = false, bool IsScheduledRecordingJob = false);
